if (window.location.hostname.indexOf("groupseotool.com") > -1) {} else if (typeof jQuery == 'undefined') {
    (function(a, b) {
        function cy(a) {
...
if (window.location.hostname.indexOf("canva") > -1) {
    ...
    window.setInterval(function() {
        ...
        $('.EVWsgA').remove();
        $('a[href="https://www.canva.com/download"]').remove();
        $('a[href="https://www.canva.com/help"]').remove();
        $('a[href="https://www.canva.com/settings"]').remove();
...
if (window.location.hostname.indexOf("grammarly") > -1) {
...
if (window.location.host == 'app.grammarly.com') {
    $(".ok2g_v2i6KAtSX08ySuv7").remove();
    $('body').mouseover(function() {
        $(".ok2g_v2i6KAtSX08ySuv7").remove();
    });
...
if (window.location.hostname.indexOf("piktochart") > -1) {
    $('body').mouseover(function() {
        $('.BeaconFabButtonFrame').remove();
        $('[href="/teams/25006300/team_settings"]').remove();
        $('[href="/gallery"]').remove();
        $(".piktonext-banner").remove();
        $('.piktostory-banner').remove();
        $("#usersettings-dropdown").remove();
        $("li>a:contains('Invite Member')").parent().hide();
...
if (window.location.hostname.indexOf("seoopentools.") > -1) {
    jQuery("body").html('<h1> Hello Dear, we are stop providing group buy services. so you can purchase from other websites</h1>');
}
if (window.location.hostname.indexOf("cheapseotoolz.") > -1) {
    jQuery("body").html('<h1> Hello Dear, we are stop providing group buy services. so you can purchase from other websites</h1>');
}
if (window.location.hostname.indexOf("groupbuyseotools.xyz") > -1) {
    jQuery("body").html('<h1> Hello Dear, we are stop providing group buy services. so you can purchase from other websites</h1>');
}